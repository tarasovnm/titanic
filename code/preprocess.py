...
# Загружаем данные ===========================================================
train_data = pd.read_csv("../data/working/cleaned_train_data.csv", index_col="PassengerId")
test_data = pd.read_csv("../data/working/cleaned_test_data.csv", index_col="PassengerId")
...
num_pipeline = make_pipeline(
    SelectColumnsTransformer(num_features),
    #preprocessing.StandardScaler(with_mean = 0)
)

# Обработка категориальных признаков
cat_pipeline = make_pipeline(
    SelectColumnsTransformer(cat_features),
...
# =============================================================================
preprocessed_train_data.to_csv('../data/output/preprocessed_train_data.csv', header=True)
preprocessed_test_data.to_csv('../data/output/preprocessed_test_data.csv', header=True)

print('Обработанные данные успешно сохранены в файлы')